 ...
 */
public class FirstPlayerFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        player1Name = (EditText) rootView.findViewById(R.id.player_name);

        player1Name.setText(this.playerName);

        ImageButton calculateButton = (ImageButton) rootView.findViewById(calcBut);
        onePlayerLP = (Button) rootView.findViewById(playerLP);
            ...
            case multiPane:
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ActivityOptionsCompat options = ActivityOptionsCompat
                            .makeSceneTransitionAnimation(getActivity(), v, getString(R.string.first_player_transition));
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (prefs != null) {
            SharedPreferences.Editor editor = prefs.edit();
            editor.putString(context.getString(R.string.pref_name_key_player1), player1Name.getText().toString());
            editor.commit();
        }
