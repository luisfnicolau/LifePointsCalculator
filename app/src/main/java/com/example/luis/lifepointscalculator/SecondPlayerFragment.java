 ...
 */
public class SecondPlayerFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        playerName = prefs.getString(context.getString(R.string.pref_name_key_player2), context.getString(R.string.pref_default_player2));

        player2Name = (EditText) rootView.findViewById(R.id.player_name);
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (prefs != null) {
            SharedPreferences.Editor editor = prefs.edit();
            editor.putString(context.getString(R.string.pref_name_key_player2), player2Name.getText().toString());
            editor.commit();
        }
