 ...
 */
public class ThirdPlayerFragment extends Fragment implements View.OnClickListener {
    ...
    int gainLP = 0;
    int lifePoints;
    static ArrayList<Integer> listLifePoints = new ArrayList<>();
    final int LANDSCAPE = Configuration.ORIENTATION_LANDSCAPE;
    Context context;
    SharedPreferences prefs;


    public ThirdPlayerFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        playerName = prefs.getString(context.getString(R.string.pref_name_key_player3), context.getString(R.string.pref_default_player3));

        player3Name = (EditText) rootView.findViewById(R.id.player_name);
        player3Name.setText(playerName);


        TextView lpGainView = (TextView) rootView.findViewById(R.id.one_player_lp);
        lpGainView.setText(listLifePoints.get(listLifePoints.size() - 1).toString());
        ...
        switch (v.getId()) {
            ...
            case calcBut:
                if (gainLP != 0) {
                    ...
                    editor = prefs.edit();
                    editor.putInt(context.getString(R.string.third_player_lp), lifePoints);
                    editor.commit();
                }
                lpGainView.setVisibility(View.INVISIBLE);
                break;
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (prefs != null) {
            SharedPreferences.Editor editor = prefs.edit();
            editor.putString(context.getString(R.string.pref_name_key_player3), player3Name.getText().toString());
            editor.commit();
        }
    ...
    public void resetGame() {
        ...
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt(context.getString(R.string.third_player_lp), -1);
        editor.commit();
    }
